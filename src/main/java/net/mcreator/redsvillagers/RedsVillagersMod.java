package net.mcreator.redsvillagers;
...
@Mod("reds_villagers")
public class RedsVillagersMod {
	public static final Logger LOGGER = LogManager.getLogger(RedsVillagersMod.class);
	public static final String MODID = "reds_villagers";

	public RedsVillagersMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		RedsVillagersModBlocks.REGISTRY.register(bus);
